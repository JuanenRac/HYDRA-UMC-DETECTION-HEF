@echo off
REM =============================================================================
REM HYDRA-UMC-DETECTION-HEF - build.bat
REM Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
REM GPL-3.0 - see LICENSE
REM =============================================================================
REM Builds HYDRA-UMC-DETECTION-HEF: creates/activates a venv, installs the
...
echo.
echo  ===============================================================
echo   H Y D R A - U M C - D E T E C T I O N - H E F  -  build
echo  ===============================================================
echo   Compiled-model (.hef) registry, versioning, and integrity checks
...
if errorlevel 1 goto :error
python -c "import hydra_umc_detection_hef; print('import OK')"
if errorlevel 1 goto :error
echo       Done.
echo.
